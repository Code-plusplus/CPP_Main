var FirepadUserList = (function() {
  ...
  FirepadUserList.prototype.makeUserEntryForSelf_ = function() {
    ...
    var nameInput = elt('div', null, { 'class': 'firepad-userlist-name-hint'} );
    nameInput.value = this.displayName_;

    var nameHint = elt('div', this.displayName_, { 'class': 'firepad-userlist-name-hint'} );
...
//var nameee=elt('div',name || 'Guest',{});
      var imagediv = elt('img',null,{src:"img/editor_user_avatar.jpg",'style':'box-shadow: 0 0 0 2pt '+color+';'});
      imagediv.style.backgroundColor = color;
      var nameDiv = elt('div',[imagediv], { 'class': 'chip' });
nameDiv.innerHTML=nameDiv.innerHTML+(name || 'Guest');
      var userDiv = elt('div', [ colorDiv, nameDiv ], {
        'class': 'firepad-userlist-user ' + 'firepad-user-' + userId, 'style':'padding:5px;'
      });
